...
municipios = carregar_cidades('C:/Users/Beatriz/OneDrive/Documentos/UFSCar/2024-1/sbd/sbd-Empresa-de-Transportes/Base de Dados/municipios.csv')
...
marcas_carros = carregar_marcas('C:/Users/Beatriz/OneDrive/Documentos/UFSCar/2024-1/sbd/sbd-Empresa-de-Transportes/Base de Dados/marcas_carros.csv')
modelos_carro = carregar_modelos('C:/Users/Beatriz/OneDrive/Documentos/UFSCar/2024-1/sbd/sbd-Empresa-de-Transportes/Base de Dados/modelos_carro.csv')
...
while len(veiculos_gerados) < 10000:  # Gerar 10000 registros de veículos únicos
...
for _ in range(100000):  # Altere o valor dentro do range para o número desejado de inserções
...
for _ in range(1000000):  # Altere o valor dentro do range para o número desejado de inserções
    # Para cada linha a ser inserida, precisamos garantir que os dados sejam únicos
    while True:
